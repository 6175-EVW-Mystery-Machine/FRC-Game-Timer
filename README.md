...
<img src="assets/MusicPlayerCollapsed.png" alt="Music player collapsed" width="700">

### Music Player (expanded)

<img src="assets/MusicPlayerExpanded.png" alt="Music player expanded" width="700">

## Setup

Open `index.html` into your browser (MS Edge, Chrome, Firefox, etc.)
...
- **Team number** (auto-fetches team name + icon from The Blue Alliance)
